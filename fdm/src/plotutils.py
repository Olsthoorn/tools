# %% [markdown]
# # This module was made in 2018 during the Juka project. It was then heavily
# used for plotting the results when calibrating the Juka model.
# It contains useful plotting functions for among others cross sections.
# So don't throw it away. It may be useful in the future.
#
# TO 2025-10-5
