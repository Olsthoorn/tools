...
# -*- coding: utf-8 -*-
# This module, named mfgridVDS, has GridVdis class as its important item.
# GridVdis is instantiated to know the 3D Modflow Grid but working for Moddflow 6.
# After instantiation any grid info can be supplied by its methods and properties.
# GridVdis has been developed from 2022 ans was used with every fdm simulation
# with Modflow 5.
#
# For Modflow 5 see mfgrid.py
