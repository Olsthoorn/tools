...
Gives an list of the KNMI weather stations.
Clicking on one provokes immediate downloading of the .txt file.

At the bottom of this web page there is a section "Meer informatie"
met items als
* Inteactieve selectie daggegevens
* Data ophalen vanuit script
* Coördinaten KNMI-stations
* KNMI automatische weerstanations land, kaart

Interactieve selectie daggegevens:
Geeft keuze van de periode, en de parameteres en de stations. Onderaan kan het fileformaat worden gekozen.
Dit is echt een ideale webpagina. Hier kan je alles wat je wilt weten direct filteren en downloaden.

Coördinaten  KNMI-stations:
Geeft: "Meteo data - information on stations in the KNMI observations network"
Dit zijn bestanden met de meta data van de actieve stations. Deze bestanden worden
af en toe vernieuwd, zodat er een lijst van is. Het blijkt dat de namen van de stations
niet altijd consistent zijn. Oudere hadden deze in hoofdletters, de nieuwe niet meer.
De kolomkoppen zijn als volgt
STN WSI	STARTT	STOPT	LOCATIE	TYPE	HOOGTE	POS_X	POS_Y	POS_NB	POS_OL
Waarbij STN het station nummer en LOCATIE de naam van het station.
Het bestand van 2026 is 78 regels lang en bevat dus meer dn de stuk of 40 weerstations
(o.a. die van het Caraïbisch gebied) maar niet alle regenstations.

* KNMI automatische weerstanations land, kaart:
Deze pagina geeft een kaartje van NL met daarop de weerstations.

* Data ophalen vanuit script:



How to download KNMI data by script is described here (site last checked on 20200516, 20260506)
http://www.knmi.nl/kennis-en-datacentrum/achtergrond/data-ophalen-vanuit-een-script

However, we can just use the more convenient requests module in Python .

Dowloading is done from: (site last checked on 20200516)
http://www.knmi.nl/nederland-nu/klimatologie/daggegevens

vars
Some convenience acronyms are defined to select related parameters as a group
