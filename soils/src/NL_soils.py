...
# the unsaturated zone using the Van Genughten-Mualem (1980) relations.
# Alternative mathematical formulation using the Brooks and Corey (1966) relations
# have been implementend in the alternative modules US_soils, which impliments
# the properties and impliments of 13 US soils using a table in Charbneau (2000).
#
# The Van Genughten-Mualem formulas used in NL_soils can be found in
# Heinen, Bakker and Wösten (2020) "Waterretentiekarakteristieken, De Staringreeks, update 2018"
# Wageingen Environmental report."
#
# @TO 2025-09-01
# """
